...
// Um aminácido pode ser um de vários tipos.
...
enum Aminoacido {
    ...
    Leucina,
    Serina,
    // ... poderíamos adicionar todos os 20 aminoácidos
}
...
fn main() {
    ...
    analisa_aminoacido(aminoacido_lido);
    analisa_aminoacido(Aminoacido::Glicina);
}

/// Uma função que usa 'match' para tomar uma decisão com base em um enum.
fn analisa_aminoacido(aa: Aminoacido) {
